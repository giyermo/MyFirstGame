class game2 extends Phaser.Scene {
    ...
    create() {
        ...
        const platPositions = [
            { x: 50, y: 600 },{ x: 250, y: 600 }, { x: 450, y: 600 }, { x: 650, y: 600 }, { x: 850, y: 600 }, 
            { x: 1050, y: 600 }, { x: 1250, y: 600 }, { x: 75, y: 200 }, /*snowman1 platform*/{ x: 250, y: 350 }, { x: 450, y: 275 },
            /*snowman2 platfrom*/{ x: 650, y: 400 }, { x: 850, y: 175 }, { x: 1050, y: 450 }, /*snowman3 platform*/{ x: 1250, y: 325 },
          ];
        ...
        //snowman1
        gameState.enemy = this.physics.add.sprite(175, 290, 'snowman');
        ...
        //snowman2
        gameState.enemy1 = this.physics.add.sprite(575, 340, 'snowman');
        ...
        //snowman3
        gameState.enemy2 = this.physics.add.sprite(1175, 265, 'snowman');
        ...
        this.physics.add.overlap(gameState.player, gameState.exit, () => {
            this.add.text(150, 50, 'You reached the exit!\n  Click to play next level.', { fontFamily: 'Arial', fontSize: 36, color: '#ffffff' });
            this.physics.pause();
            gameState.active = false;
            this.anims.pauseAll();
            gameState.enemy.move.stop();
            ...
            this.anims.resumeAll();
            setTimeout(() => {this.scene.start('game3');}, 1001);
          });
